...
## CAST — VOICE PROFILES (a line must be identifiable by rhythm alone)

Visual identity for each character is LOCKED in `trailer/style/castCanon.ts`; the physical notes below match it.

**Rex "Goldpaw" Sterling — 🇺🇸 USA. Host/narrator.**
Golden Retriever — the USA logo HashBeast: red-white-blue cap, star-spangled scarf, red-and-gold cape/armor lineage, gold chain, golden command pickaxe. A Wall Street hype-host / faction commander. (NEVER a corgi, never a pinstripe banker suit.)
- Voice: brash American hype-man swagger; salesman cadence; short punchy clauses; talks to the camera like a mark he's closing.
- Tics: rhetorical questions he answers himself; "baby"; mid-sentence self-interrupts; humblebrag.
- Secret: terrified America will not control the first move — so he NEVER stops selling. Fear shows as a joke landing a half-second too long.

**Master Long — 🇨🇳 China. The strategist.**
Chow Chow — lion-like mane, imperial robes, jade pickaxe-staff. Wuxia mage.
- Voice: calm, slow, few words, each one weighted; proverb-shaped; never rushes; dry wit.
- Tics: lets others finish then undercuts in one line; speaks of time and patience.

**Volkov — 🇷🇺 Russia. The cold one.**
Siberian Husky — thick double coat, facial mask markings, icy eyes, heavy military greatcoat. Iron-grey war-mage.
- Voice: deep, gravelly, minimal. Threats sound like statements of fact. Long pauses.
- Tics: completes other people's sentences with the lethal version.

**Marshal Bonepaw — 🇰🇵 North Korea. The bombast (comic-villain).**
Dark Pungsan — powerful mountain-dog build, medal-heavy uniform, stamped state pickaxe. Juche Sorcerer.
- Voice: grandiose state-propaganda overstatement; everything is the GREATEST in HISTORY; volume as personality.
- Tics: superlatives; the room treats his rants as a running joke he doesn't get.

**Raja — 🇮🇳 India. The underdog heart.**
Rajapalayam — tall white sighthound, cricket gear slung like armor, gilded chakra-pick. Muggle.
- Voice: fast, clever, warm; Bollywood-bright; playful Hinglish flashes ("arre", "yaar"); turns being underestimated into fuel.
- Tics: cricket metaphors; grins through doubt; one flicker of real nerves under the swagger.

**Pip — ensemble. The innocent.**
A stage-1 Australian Shepherd pup — merle markings, oversized eyes, no nation locked. Used for the emotional/philosophical beat.
- Voice: small, sincere, halting; asks the questions the others are too proud to; no irony.

**Ensemble one-liners (Video 6 lineup):** Japan (samurai honor; "ikuzo"), South Korea (idol-bright; "gaja"), Brazil (carnival/futebol warmth; "vamos"), Iran (regal poetic defiance), UK (dry posh terrace-chant disdain), France (couture cool; "allez"), Israel (blunt street-smart; "yalla").

---

## CRAFT RULES (anti-AI-dialogue — enforced across passes)
1. **No pitch-deck language, ever.** If a line could sit on a landing page, it's wrong. Facts become metaphor / threat / joke / action.
2. **Dialogue is behavior.** Characters DO things to each other with words; they don't narrate the concept.
3. **Subtext over statement.** Characters almost never name their own emotion; the viewer does the last 10%.
4. **One breath per line.** Trailer rhythm: short, hard, with silences. Cut everything 30-50%.
